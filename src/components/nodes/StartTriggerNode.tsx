...
export function StartTriggerNode({ id, data, selected }: NodeProps) {
    ...
    return (
        <div
            className={`group relative rounded-2xl min-w-[200px] transition-all duration-300 ${selected
                    ? 'bg-gradient-to-br from-emerald-500 to-teal-600 shadow-2xl shadow-emerald-500/40 scale-105'
                    : 'bg-gradient-to-br from-emerald-600 to-teal-700 hover:shadow-xl hover:shadow-emerald-500/30 hover:scale-[1.02]'
                }`}
        ...
        >
            <div className="flex items-center" style={{ gap: '16px' }}>
                ...
                <div>
                    <p className="text-xs text-emerald-100 uppercase tracking-wider font-medium">Trigger</p>
            ...
            <Handle
                ...
                className="!w-4 !h-4 !bg-emerald-300 !border-[3px] !border-white !-bottom-2"
            />
        </div>
    );
}
