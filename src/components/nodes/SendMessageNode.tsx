    ...
    return (
        <div
            className={`group relative rounded-2xl min-w-[200px] transition-all duration-300 ${selected
                    ? 'bg-gradient-to-br from-purple-500 to-pink-600 shadow-2xl shadow-purple-500/40 scale-105'
                    : 'bg-gradient-to-br from-purple-600 to-pink-700 hover:shadow-xl hover:shadow-purple-500/30 hover:scale-[1.02]'
                }`}
        ...
        >
            <Handle
                ...
                className="!w-4 !h-4 !bg-purple-300 !border-[3px] !border-white !-top-2"
            />
            ...
            <div className="flex items-center" style={{ gap: '16px' }}>
                ...
                <div>
                    <p className="text-xs text-purple-100 uppercase tracking-wider font-medium">Action</p>
                    <p className="text-white font-bold text-lg">{data.label as string}</p>
                    {username && (
                        <p className="text-sm text-purple-200" style={{ marginTop: '4px' }}>@{username}</p>
                    )}
                </div>
            </div>
            ...
            <Handle
                ...
                className="!w-4 !h-4 !bg-purple-300 !border-[3px] !border-white !-bottom-2"
            />
        </div>
    );
}
